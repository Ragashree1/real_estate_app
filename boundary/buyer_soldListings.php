...
require_once "../controller/buyerViewSoldListingController.php";
require_once "../controller/buyerSearchSoldListingController.php";
...
function searchSoldListings()
{
    global $allListing;
    global $searchSoldListingController;
                    ...
                    <?php if (isset($listing['title'])) : ?>
                        <h2 class="listing-title">
                            <?php if ($loggedInProfile == 'seller'): ?>
                                <u><a href="seller_viewSingleSoldListing.php?listing_id=<?php echo $listing['listing_id']; ?>" style="color:black"><?= $listing['title']; ?></a></u>
                            <?php else: ?>
                                <u><a href="buyer_viewSingleSoldListing.php?listing_id=<?php echo $listing['listing_id']; ?>" style="color:black"><?= $listing['title']; ?></a></u>
                            <?php endif; ?>
                        </h2> </u>
                    <?php endif; ?>
